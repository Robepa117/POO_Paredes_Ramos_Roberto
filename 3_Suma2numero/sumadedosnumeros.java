...
Para poder hacer el programa la suma de dos numeros 

debemos de entender el algoritmo de la suma 

declarar variables

num1 num 2 resultado
...
class sumadedosnumeros{
    ...
    public static void main(String[] args){
        ...
        /*
        Para realizar una insatancia del objeto se debe de colocar:

        Nombreclase nombreobjeto = new Nombreclase();
        
        System.in Es una clase superior donde nosotros podemos obtener los 
        datos que vienen por parte de la enyrada de la computadora
        ...
        */
        ...
        do{
            System.out.println("Introduce lso numeros que quieras sumar; si pones 0 se detiene la suma: ");
